...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2016 at 03:27 PM
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`main_uid`) REFERENCES `resident` (`uid`);
